...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class FirebaseAppdistributionLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        private final FirebaseAppdistributionApiLibraryAccessors laccForFirebaseAppdistributionApiLibraryAccessors = new FirebaseAppdistributionApiLibraryAccessors(owner);

        public FirebaseAppdistributionLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>appdistribution</b> with <b>com.google.firebase:firebase-appdistribution</b> coordinates and
         * with <b>no version specified</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
            return create("firebase.appdistribution");
        }

        /**
         * Group of libraries at <b>firebase.appdistribution.api</b>
         */
        public FirebaseAppdistributionApiLibraryAccessors getApi() {
            return laccForFirebaseAppdistributionApiLibraryAccessors;
        }

    }

    public static class FirebaseAppdistributionApiLibraryAccessors extends SubDependencyFactory {

        public FirebaseAppdistributionApiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>ktx</b> with <b>com.google.firebase:firebase-appdistribution-api-ktx</b> coordinates and
         * with version reference <b>firebaseAppdistributionApiKtx</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getKtx() {
            return create("firebase.appdistribution.api.ktx");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>firebaseAppdistributionApiKtx</b> with value <b>16.0.0-beta14</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getFirebaseAppdistributionApiKtx() { return getVersion("firebaseAppdistributionApiKtx"); }
        ...
        /**
         * Version alias <b>material</b> with value <b>latest.release</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>pagingRuntimeKtx</b> with value <b>3.3.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
